...
<div class="login-forms">
    <form class="card" method="POST" onsubmit="return validateProduct();" name="addproduct" enctype="multipart/form-data">
...
if(isset($_POST['update']))
{
    ...
    $query = $conn->prepare("UPDATE `products` SET `category` = ?, `price` = ?, `image` = ? WHERE `product_code` = ?");
