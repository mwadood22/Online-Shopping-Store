...
<div class="login-forms">
    <form class="card" method="POST" onsubmit="return validateLoginForm();" name="loginform" action="feedback-insert.php">
...
<div class="card-body">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" name="feedback" placeholder="Write feedback.."></textarea>
          </div>
        <br>
