...
?>
        ...
        <div class="col-lg-12">
            <br><br>
            <h1 class="text-grey text-center">New Arrivals</h1>
            <br>
            <br>
            <div class="disp">
        <?php
              ...
              $conn = $obj1->OpenCon();
               $count = 0;
               $ql=$conn->prepare("select * from products where category = 'n' or category = 'N'");
               
               Class MyClass
               {
                 public function display($res,$count)
                 {
                   ?>
                 <div class="card d-inline-block" style="width: 18rem;">
                 <?php echo '<img class="card-img-top" src="data:image/jpeg;base64,'.base64_encode( $res['image'] ).'"/>'?>
                   <div class="card-body">
                   <p class="card-text text-white">Rs: <?php echo $res['price']; ?>/-</p>
                   </div>
                   </div>
                   <?php
                   $count++;
