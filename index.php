...
?>
       ...
       <div class="slider">
           <figure>
               <img src="graphics/11.jpg">
               <img src="graphics/12.jpeg">
               <img src="graphics/13.jpg">
               <img src="graphics/14.jpg">
           </figure>
       </div>
       <div class="text">
        <br><br><h4 class="text-center"><strong>Available Now!</strong></h4>
         <br><p class="text-center">Visit our shop to see amazing creations from our designers.</p>
       </div>
       <br> <br>
       <div class="text-center centre">
        <ul class="list-unstyled list-inline text-center">
          <li class="list-inline-item"><img src="graphics/body.jpeg"> </li>
        <li class="list-inline-item"><img src="graphics/body1.jpeg"> </li>
      </ul>
      </div>
     <hr>
      
       <div class="text-center">
        <img src="graphics/banner.jpeg">
      </div>
