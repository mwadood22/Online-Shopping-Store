...
<br><br>
<h1 class="text-grey text-center">Our Stores</h1>
<br><br>
            <div id="map" class="m-auto" style="width: 60%; height: 400px; border: 1px solid black;"></div>
<br><br>
...
<script type="text/javascript">
    ...
    <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBE-b8wN2UW-gubSY1BBGmzdgA5CkCv48s&callback=initMap">
    </script>
