...
?>
           ...
           <div class="about">
            <br><br><br>
               <img  src="graphics/abt.jpg" alt="about">
               <p2><strong>Who We Are :</strong></p2>
              <br> <p>A high-street brand introduced by one of the largest names in the textile industry, 
                  X-Port is celebrated for combining 100% pure fabric with unprecedented design aesthetic to create 
                  designer wear at an affordable price.This meld of exquisite design and high class fabric has resulted 
                  in the breakthrough of this one of a kind retail brand. X-Port’s commitment to quality fabric over
                   the years has made it a household name, synonymous with excellence.Effortless style, authenticity and 
                   easy-going living are at the heart of the brand’s philosophy.For every garment, X-Port pays maximum 
                   attention to fabric selection, fitting and perfect quality.  X-Port has always been able to provide the best in
                    fashion through a unique and flexible model that is open to adapting to the constant changes that occur during a season.
                     ...
                     for a collection that is fun, vibrant, and expressive.<br>

                  We hope you enjoy wearing them as much we love making them for you! </p><br><br><br><br>
              </div>
